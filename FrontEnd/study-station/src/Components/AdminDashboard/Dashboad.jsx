...
const STATS = [
    {
        ...
        number: "2,841", label: "Total Users", trend: "up", trendText: "+12% this month",
    ...
    },
    {
        ...
        number: "1,204", label: "Total Resources", trend: "up", trendText: "+8% this month",
    ...
    },
    {
        ...
        number: "348", label: "Active Sessions", trend: "stable", trendText: "Live right now",
    ...
    },
    {
        ...
        number: "9,672", label: "Posts Count", trend: "up", trendText: "+23% this month",
...
const ACTIVITIES = [
    { dot: "#3D718D", text: <><span style={{ color: "#3D718D" }}>Sara Ahmed</span> joined a study room</>, time: "2 minutes ago" },
    { dot: "#658FA5", text: <><span style={{ color: "#3D718D" }}>Khaled Mostafa</span> uploaded a resource</>, time: "14 minutes ago" },
    { dot: "#f87171", text: "Post flagged for moderation review", time: "31 minutes ago" },
    { dot: "#3D718D", text: <><span style={{ color: "#3D718D" }}>Nour Omar</span> registered a new account</>, time: "1 hour ago" },
    { dot: "#8FB7CC", text: <><span style={{ color: "#3D718D" }}>Mohamed Yasser</span> posted in Algorithms room</>, time: "2 hours ago" },
    { dot: "#658FA5", text: 'New resource "Data Structures PDF" published', time: "3 hours ago" },
    { dot: "#f87171", text: <span>User <span style={{ color: "#3D718D" }}>user_099</span> account suspended</span>, time: "5 hours ago" },
];

const QUICK_STATS = [
    { label: "Active Users", value: "2,714", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /></svg> },
    { label: "Study Rooms Open", value: "56", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" /><rect x="14" y="14" width="7" height="7" /><rect x="3" y="14" width="7" height="7" /></svg> },
    { label: "Flagged Content", value: "6", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg> },
    { label: "Avg. Session (min)", value: "42", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M12 8v4l3 3" /></svg> },
    { label: "Resources Today", value: "+18", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /></svg> },
    { label: "New Signups Today", value: "34", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><line x1="19" y1="8" x2="19" y2="14" /><line x1="22" y1="11" x2="16" y2="11" /></svg> },
];
...
export default function Dashboard() {
    ...
    if (loading) return <div style={{ marginLeft: 230, marginTop: 60, padding: "2rem" }}>Loading...</div>;
    if (error) return <div style={{ marginLeft: 230, marginTop: 60, padding: "2rem", color: "red" }}>Error: {error}</div>;
            ...
            <main style={{
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                    ...
                    <div style={{ fontSize: "0.8rem", color: textMuted, fontWeight: 500, marginTop: 3 }}>
                        Welcome back, Mariam — here's what's going on.
                    </div>
                </div>
                ...
                <div className="db-stats-grid" style={{
                    ...
                    {STATS.map((s) => (
                        <div
                            ...
                            style={{
                                background: cardBg, border: `1px solid ${borderFaint}`,
                        ...
                        >
                            ...
                            <div style={{ marginTop: "0.65rem", display: "flex", alignItems: "center", gap: 4, fontSize: "0.72rem", fontWeight: 700, color: s.trend === "up" ? "#22c55e" : "#658FA5" }}>
                        ...
                        <div style={{ padding: "0.5rem 0" }}>
                            {ACTIVITIES.map((a, i) => (
                                <div
                                    ...
                                    style={{ display: "flex", alignItems: "center", gap: "0.75rem", padding: "0.65rem 1.25rem" }}
                                    onMouseEnter={e => e.currentTarget.style.background = surface3}
                                    onMouseLeave={e => e.currentTarget.style.background = "transparent"}
                                >
                                    <div style={{ width: 8, height: 8, borderRadius: "50%", flexShrink: 0, background: a.dot }} />
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        <div style={{ fontSize: "0.8rem", fontWeight: 600, color: textPrimary }}>{a.text}</div>
                                        <div style={{ fontSize: "0.7rem", color: textMuted, marginTop: 1 }}>{a.time}</div>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div style={{ padding: "0.75rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                            {QUICK_STATS.map((q) => (
                                <div key={q.label} style={{
                                    ...
                                    background: surface3, borderRadius: 10, border: `1px solid ${borderFaint}`,
                                }}>
