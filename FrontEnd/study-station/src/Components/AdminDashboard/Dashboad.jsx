...
export default function Dashboard() {
    ...
    // ✅ جوا الـ component — dashData متاحة هنا
    ...
    if (loading) return (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100vh", background: bgColor, color: textMuted, fontFamily: "'Sora', sans-serif" }}>
            Loading...
        </div>
    );
    ...
    return (
        <>
            ...
            <SidebarDashboard />
            <TopbarDashboard />
            <main style={{ marginLeft: 230, marginTop: 60, height: "calc(100vh - 60px)", overflowY: "auto", padding: "1.75rem", background: bgColor, fontFamily: "'Sora', sans-serif" }}>
